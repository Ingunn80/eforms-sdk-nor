...
For now we are not returning any validation results. Please make sure that you are using valid and well-formed eForms messages before testing the integration. To test for validity during development please use:
* debug = true parameter and we return valdation errors/warnings.
